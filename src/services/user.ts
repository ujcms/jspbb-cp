...
export const updateRole = async (data: any) =>
  request(`/api/cp/roles?_method=put`, { method: 'POST', data });
export const updateRoleOrder = async (data: number[]) =>
  request(`/api/cp/roles/order?_method=put`, { method: 'POST', data });
export const deleteRole = async (data: number[]) =>
  request('/api/cp/roles?_method=delete', { method: 'POST', data });
...
export const updateGroup = async (data: any) =>
  request(`/api/cp/groups?_method=put`, { method: 'POST', data });
export const updateGroupOrder = async (data: number[]) =>
  request(`/api/cp/groups/order?_method=put`, { method: 'POST', data });
export const deleteGroup = async (data: number[]) =>
  request('/api/cp/groups?_method=delete', { method: 'POST', data });
...
export const updateUser = async (data: any) =>
  request(`/api/cp/users?_method=put`, { method: 'POST', data });
export const deleteUser = async (ids: number[]) =>
  request('/api/cp/users?_method=delete', { method: 'POST', data: ids });
export const usernameValidation = async (username?: string) =>
  request('/api/cp/users/username-validation', { params: { username } });
export const emailValidation = async (email?: string) =>
  request('/api/cp/users/email-validation', { params: { email } });
export const mobileValidation = async (mobile: any) =>
  request('/api/cp/users/mobile-validation', { params: { mobile } });
