...
export const deleteSms = async (data: number[]) => request('/api/cp/sms?_method=delete', {method: 'POST', data});
...
export const deleteAccess = async (data: number[]) => request('/api/cp/access?_method=delete', {method: 'POST', data});
