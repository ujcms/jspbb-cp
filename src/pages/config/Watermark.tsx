        ...
        >
          <Row gutter={16}>
            <Col span={24} lg={12} xxl={6}>
              <Form.Item
                name="enabled"
                label={formatMessage({ id: 'config.watermark.enabled' })}
                rules={[{ required: true }]}
              >
                <Radio.Group
            ...
            <Col span={24} lg={12} xxl={6}>
              <Form.Item
                name="overlay"
                label={formatMessage({ id: 'config.watermark.overlay' })}
                rules={[{ required: true }]}
              >
                <Input maxLength={255} />
              </Form.Item>
            ...
            <Col span={24} lg={12} xxl={6}>
              <Form.Item
                name="position"
                label={formatMessage({ id: 'config.watermark.position' })}
                rules={[{ required: true }]}
              >
                <Select
                  options={[1, 2, 3, 4, 5, 6, 7, 8, 9].map((item) => ({
                    value: item,
                    label: formatMessage({ id: `config.watermark.position.${item}` }),
                  }))}
                />
              </Form.Item>
            </Col>
            <Col span={24} lg={12} xxl={6}>
              <Form.Item
                name="dissolve"
                label={labelTip(formatMessage, { id: 'config.watermark.dissolve' })}
                rules={[
                  {
                    required: true,
                    pattern: /^[0-9]*$/,
            ...
            <Col span={24} lg={12} xxl={6}>
              <Form.Item
                name="minWidth"
                label={labelTip(formatMessage, { id: 'config.watermark.minWidth' })}
                rules={[
                  {
                    required: true,
                    pattern: /^[0-9]*$/,
            ...
            <Col span={24} lg={12} xxl={6}>
              <Form.Item
                name="minHeight"
                label={labelTip(formatMessage, { id: 'config.watermark.minHeight' })}
                rules={[
                  {
                    required: true,
                    pattern: /^[0-9]*$/,
