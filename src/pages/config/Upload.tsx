        ...
        >
          <Row gutter={16}>
            <Col span={24} lg={12} xxl={6}>
              <Form.Item
                name="fileTypes"
                label={labelTip(formatMessage, { id: 'config.upload.fileTypes' })}
              >
                <Input maxLength={255} />
              </Form.Item>
            </Col>
            <Col span={24} lg={12} xxl={6}>
              <Form.Item
                name="fileLimit"
                label={labelTip(formatMessage, {
                  id: 'config.upload.fileLimit',
                  tipId: 'config.upload.limit.tooltip',
                })}
                rules={[
                  {
                    required: true,
            ...
            <Col span={24} lg={12} xxl={6}>
              <Form.Item
                name="imageTypes"
                label={labelTip(formatMessage, { id: 'config.upload.imageTypes' })}
              >
                <Input maxLength={255} />
              </Form.Item>
            </Col>
            ...
            <Col span={24} lg={12} xxl={6}>
              <Form.Item
                name="videoTypes"
                label={labelTip(formatMessage, { id: 'config.upload.videoTypes' })}
              >
                <Input maxLength={255} />
              </Form.Item>
            </Col>
            ...
            <Col span={24} lg={12} xxl={6}>
              <Form.Item
                name="imageMaxWidth"
                label={labelTip(formatMessage, { id: 'config.upload.imageMaxWidth' })}
                rules={[
                  {
                    required: true,
                    pattern: /^[0-9]*$/,
            ...
            <Col span={24} lg={12} xxl={6}>
              <Form.Item
                name="imageMaxHeight"
                label={labelTip(formatMessage, { id: 'config.upload.imageMaxHeight' })}
                rules={[
                  {
                    required: true,
                    pattern: /^[0-9]*$/,
