...
const AnswerForm: FC<TableModelFormProps> = (props: TableModelFormProps) => {
  ...
  const showStatus = (isEdit: boolean, bean: any, formatMessage: any) =>
    ...
    bean.status !== undefined && (
      <span>
        ({formatMessage({ id: 'answer.status' })}:{' '}
        {formatMessage({ id: `answer.status.${bean.status}` })})
      </span>
    );
        ...
        >
          ...
          <Row gutter={16}>
            <Col span={24} lg={12} xxl={6}>
              <Form.Item
                name={['bean', 'status']}
                label={formatMessage({ id: 'answer.status' })}
                rules={[{ required: true }]}
              >
                <Radio.Group
                  options={[0, 1, 2, 3].map((item) => ({
                    value: item,
                    label: formatMessage({ id: `answer.status.${item}` }),
                  }))}
                />
              </Form.Item>
            </Col>
            <Col span={24} lg={12} xxl={6}>
              <Form.Item
                name={['bean', 'accepted']}
                label={formatMessage({ id: 'answer.accepted' })}
                rules={[{ required: true }]}
              >
                <Radio.Group
            ...
            <Col span={24} lg={12} xxl={6}>
              <Form.Item
                name={['bean', 'acceptDate']}
                label={formatMessage({ id: 'answer.acceptDate' })}
              >
            ...
            <Col span={24} lg={12} xxl={6}>
              <Form.Item
                ...
                label={formatMessage({ id: 'answer.ext.editCount' })}
                rules={[
                  {
                    required: true,
                    pattern: /^[0-9]*$/,
          ...
          <Row gutter={16}>
            <Col span={24} lg={12} xxl={6}>
              <Form.Item
                name={['bean', 'ups']}
                label={formatMessage({ id: 'answer.ups' })}
                rules={[
                  {
                    required: true,
                    pattern: /^[0-9]*$/,
            ...
            <Col span={24} lg={12} xxl={6}>
              <Form.Item
                name={['bean', 'downs']}
                label={formatMessage({ id: 'answer.downs' })}
                rules={[
                  {
                    required: true,
                    pattern: /^[0-9]*$/,
            ...
            <Col span={24} lg={12} xxl={6}>
              <Form.Item
                ...
                label={formatMessage({ id: 'answer.commentCount' })}
                rules={[
                  {
                    required: true,
                    pattern: /^[0-9]*$/,
            ...
            <Col span={24} lg={12} xxl={6}>
              <Form.Item
                ...
                label={formatMessage({ id: 'answer.favoriteCount' })}
                rules={[
                  {
                    required: true,
                    pattern: /^[0-9]*$/,
          ...
          <Row gutter={16}>
            <Col span={24} lg={12} xxl={6}>
              <Form.Item
                name={['bean', 'created']}
                label={formatMessage({ id: 'answer.created' })}
                rules={[{ required: true }]}
              >
                <DatePicker2 format="YYYY-MM-DD HH:mm:ss" />
              </Form.Item>
            ...
            <Col span={24} lg={12} xxl={6}>
              <Form.Item
                name={['bean', 'editDate']}
                label={formatMessage({ id: 'answer.editDate' })}
              >
                <DatePicker2 format="YYYY-MM-DD HH:mm:ss" />
              </Form.Item>
            </Col>
            ...
            <Col span={24} lg={12} xxl={6}>
              <Form.Item
                ...
                label={formatMessage({ id: 'answer.editUser' })}
              >
                <Input disabled />
              </Form.Item>
            </Col>
          ...
          <Row gutter={16}>
            <Col span={24} lg={12} xxl={6}>
              <Form.Item
                name={['ext', 'ip']}
                label={formatMessage({ id: 'answer.ext.ip' })}
                rules={[{ required: true }]}
              >
                <Input disabled />
              </Form.Item>
            ...
            <Col span={24} lg={12} xxl={6}>
              <Form.Item
                name={['ext', 'ipProvince']}
                label={formatMessage({ id: 'answer.ext.ipProvince' })}
              >
                <Input disabled />
              </Form.Item>
            </Col>
            <Col span={24} lg={12} xxl={6}>
              <Form.Item
                name={['ext', 'ipCountry']}
                label={formatMessage({ id: 'answer.ext.ipCountry' })}
              >
                <Input disabled />
              </Form.Item>
            </Col>
            <Col span={24} lg={12} xxl={6}>
              <Form.Item
                name={['ext', 'ipCity']}
                label={formatMessage({ id: 'answer.ext.ipCity' })}
              >
                <Input disabled />
              </Form.Item>
            </Col>
  ...
  return (
    <ModelForm
      title="menu.content.answer"
      queryBean={queryAnswer}
      updateBean={updateAnswer}
      deleteBean={deleteAnswer}
      unsaved={unsaved}
