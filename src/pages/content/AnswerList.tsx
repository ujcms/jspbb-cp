...
const AnswerList: FC = () => {
  ...
  const { data, run, loading } = useRequest(
    () =>
      queryAnswerList({
        ...
        ...parseSorter(sorter),
        pageSize: getLocalSettingsPageSize('answers'),
      }),
    { formatResult },
  );
  const handleAdd = () => {
  ...
  const columns = [
    ...
    {
      title: formatMessage({ id: 'answer.user' }),
    ...
    {
      title: formatMessage({ id: 'answer.editUser' }),
    ...
    {
      title: formatMessage({ id: 'answer.created' }),
      dataIndex: 'created',
    ...
    {
      title: formatMessage({ id: 'answer.editDate' }),
      dataIndex: 'editDate',
    ...
    {
      title: formatMessage({ id: 'answer.acceptDate' }),
      dataIndex: 'acceptDate',
      key: 'Q_GE_acceptDate_DateTime,Q_LE_acceptDate_DateTime',
      sorter: true,
      sortOrder: getSortOrder(sorter, 'acceptDate'),
      filterDropdown: filterDropdownDate,
      filteredValue: filters['Q_GE_created_DateTime,Q_LE_created_DateTime'] || null,
      filterIcon,
      render: (val: any) => <>{val && moment(val).format('YYYY-MM-DD HH:mm:ss')}</>,
    ...
    {
      title: formatMessage({ id: 'answer.ups' }),
      dataIndex: 'ups',
    ...
    {
      title: formatMessage({ id: 'answer.downs' }),
      dataIndex: 'downs',
    ...
    {
      title: formatMessage({ id: 'answer.favoriteCount' }),
    ...
    {
      title: formatMessage({ id: 'answer.commentCount' }),
    ...
    {
      title: formatMessage({ id: 'answer.ext.editCount' }),
      dataIndex: ['ext', 'editCount'],
      key: 'Q_GE_ManswerExt-editCount_Int,Q_LE_ManswerExt-editCount_Int',
      sorter: true,
      sortName: 'ManswerExt-editCount',
      sortOrder: getSortOrder(sorter, ['ext', 'editCount']),
      filterDropdown: filterDropdownNumber,
      filteredValue: filters['Q_GE_ManswerExt-editCount_Int,Q_LE_ManswerExt-editCount_Int'] || null,
      filterIcon,
      display: 'none',
    },
    {
      title: formatMessage({ id: 'answer.accepted' }),
      dataIndex: 'accepted',
      key: 'Q_EQ_accepted_Boolean',
      sorter: true,
      sortOrder: getSortOrder(sorter, 'accepted'),
      filteredValue: filters.Q_EQ_accepted_Boolean || null,
      filters: [true, false].map((item) => ({
        text: formatMessage({ id: item ? 'yes' : 'no' }),
        value: item,
      })),
      ...
      render: (val: any) => (
        <Badge
          ...
          text={formatMessage({ id: val ? 'yes' : 'no' })}
        />
      ),
    },
    {
      title: formatMessage({ id: 'answer.status' }),
      dataIndex: 'status',
      key: 'Q_In_status_Int',
      sorter: true,
      ...
      filters: [0, 1, 2, 3].map((item) => ({
        text: formatMessage({ id: `answer.status.${item}` }),
        value: item,
      })),
      render: (val: any) => (
        <Badge
          status={val === 0 ? 'success' : 'error'}
          text={formatMessage({ id: `answer.status.${val}` })}
        />
      ),
    },
    {
      title: formatMessage({ id: 'answer.ext.ip' }),
      dataIndex: ['ext', 'ip'],
      key: 'Q_Contains_ManswerExt-ip',
      sorter: true,
      sortName: 'ManswerExt-ip',
      sortOrder: getSortOrder(sorter, ['ext', 'ip']),
      filterDropdown,
      filterIcon,
      filteredValue: filters['Q_Contains_ManswerExt-ip'] || null,
      display: 'none',
    },
    {
      title: formatMessage({ id: 'answer.ext.ipCountry' }),
      dataIndex: ['ext', 'ipCountry'],
      key: 'Q_Contains_ManswerExt-ipCountry',
      sorter: true,
      sortName: 'ManswerExt-ipCountry',
      sortOrder: getSortOrder(sorter, ['ext', 'ipCountry']),
      filterDropdown,
      filterIcon,
      filteredValue: filters['Q_Contains_ManswerExt-ipCountry'] || null,
      display: 'none',
    },
    {
      title: formatMessage({ id: 'answer.ext.ipProvince' }),
      dataIndex: ['ext', 'ipProvince'],
      key: 'Q_Contains_ManswerExt-ipProvince',
      sorter: true,
      sortName: 'ManswerExt-ipProvince',
      sortOrder: getSortOrder(sorter, ['ext', 'ipProvince']),
      filterDropdown,
      filterIcon,
      filteredValue: filters['Q_Contains_ManswerExt-ipProvince'] || null,
      display: 'none',
    },
    {
      title: formatMessage({ id: 'answer.ext.ipCity' }),
      dataIndex: ['ext', 'ipCity'],
      key: 'Q_Contains_ManswerExt-ipCity',
      sorter: true,
      sortName: 'ManswerExt-ipCity',
      sortOrder: getSortOrder(sorter, ['ext', 'ipCity']),
      filterDropdown,
      filterIcon,
      filteredValue: filters['Q_Contains_ManswerExt-ipCity'] || null,
      display: 'none',
    },
    {
      ...
      render: (text: any, record: any) => (
        <Space split={<Divider type="vertical" />} size={0}>
          <Access accessible={access['answer:edit']}>
    ...
    <PageContainer header={{ title: null }}>
      <Card bordered={false}>
        <QueryFilter form={form} onFinish={handleSearch} onReset={handleReset} layout="inline">
          <ProFormText
            name="Q_Contains_ManswerExt-markdown"
            label={formatMessage({ id: 'answer.ext.markdown' })}
          />
          <ProFormText
            name="Q_Contains_user-username"
            label={formatMessage({ id: 'answer.user' })}
          />
        </QueryFilter>
