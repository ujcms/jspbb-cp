...
const AccessList: FC = () => {
  ...
  const { data, run, loading } = useRequest(
    () =>
      queryAccessList({
        ...
        ...parseSorter(sorter),
        pageSize: getLocalSettingsPageSize('access'),
      }),
    { formatResult },
  );
  ...
  const columns = [
    ...
    {
      title: formatMessage({ id: 'access.ext.url' }),
      dataIndex: ['ext', 'url'],
      key: 'Q_Contains_MaccessExt-url',
      sorter: true,
      sortOrder: getSortOrder(sorter, ['ext', 'url']),
      filterDropdown,
      filterIcon,
      filteredValue: filters['Q_Contains_MaccessExt-url'] || null,
    },
    {
      title: formatMessage({ id: 'access.ext.referrer' }),
      dataIndex: ['ext', 'referrer'],
      key: 'Q_Contains_MaccessExt-referrer',
      sorter: true,
      sortOrder: getSortOrder(sorter, ['ext', 'referrer']),
      filterDropdown,
      filterIcon,
      filteredValue: filters['Q_Contains_MaccessExt-referrer'] || null,
      display: 'none',
    },
    {
      title: formatMessage({ id: 'access.ext.userAgent' }),
      dataIndex: ['ext', 'userAgent'],
      key: 'Q_Contains_MaccessExt-userAgent',
      sorter: true,
      sortOrder: getSortOrder(sorter, ['ext', 'userAgent']),
      filterDropdown,
      filterIcon,
      filteredValue: filters['Q_Contains_MaccessExt-userAgent'] || null,
      display: 'none',
    },
    {
      title: formatMessage({ id: 'access.date' }),
      dataIndex: 'date',
      key: 'Q_GE_date_DateTime,Q_LE_date_DateTime',
      sorter: true,
      sortOrder: getSortOrder(sorter, 'date'),
      filterDropdown: filterDropdownDate,
      filteredValue: filters['Q_GE_date_DateTime,Q_LE_date_DateTime'] || null,
      filterIcon,
      render: (val: any) => <>{moment(val).format('YYYY-MM-DD HH:mm:ss')}</>,
    },
    {
      title: formatMessage({ id: 'access.ip' }),
      dataIndex: 'ip',
      key: 'Q_Contains_ip',
      sorter: true,
    ...
    {
      title: formatMessage({ id: 'access.country' }),
      dataIndex: 'country',
    ...
    {
      title: formatMessage({ id: 'access.province' }),
      dataIndex: 'province',
    ...
    {
      title: formatMessage({ id: 'access.city' }),
      dataIndex: 'city',
      key: 'Q_Contains_city',
      sorter: true,
    ...
    {
      title: formatMessage({ id: 'access.user' }),
    ...
    {
      title: formatMessage({ id: 'access.cookie' }),
      dataIndex: 'cookie',
      key: 'Q_Contains_cookie',
      sorter: true,
      sortOrder: getSortOrder(sorter, 'cookie'),
      filterDropdown,
      filterIcon,
      filteredValue: filters.Q_Contains_cookie || null,
      display: 'none',
    },
    {
      title: formatMessage({ id: 'access.source' }),
      dataIndex: 'source',
      key: 'Q_Contains_source',
      sorter: true,
      sortOrder: getSortOrder(sorter, 'source'),
      filterDropdown,
      filterIcon,
      filteredValue: filters.Q_Contains_source || null,
      display: 'none',
    },
    {
      title: formatMessage({ id: 'access.browser' }),
      dataIndex: 'browser',
      key: 'Q_Contains_browser',
      sorter: true,
      sortOrder: getSortOrder(sorter, 'browser'),
      filterDropdown,
      filterIcon,
      filteredValue: filters.Q_Contains_browser || null,
      display: 'none',
    },
    {
      title: formatMessage({ id: 'access.os' }),
      dataIndex: 'os',
      key: 'Q_Contains_os',
      sorter: true,
      sortOrder: getSortOrder(sorter, 'os'),
      filterDropdown,
      filterIcon,
      filteredValue: filters.Q_Contains_os || null,
      display: 'none',
    },
    {
      title: formatMessage({ id: 'access.device' }),
      dataIndex: 'device',
      key: 'Q_In_device',
      sorter: true,
      sortOrder: getSortOrder(sorter, 'device'),
      filteredValue: filters.Q_In_device || null,
      filters: [0, 1, 2, 3, 4, 5, 6].map((item) => ({
        text: formatMessage({ id: `access.device.${item}` }),
        value: item,
      })),
      render: (val: any) => <FormattedMessage id={`access.device.${val}`} />,
      display: 'none',
    },
    {
